...
namespace TafeSAEnrolment.Test
{
    ...
    public class BinaryTreeTest
    {
        ...
        {
            // Assert
            //Assert.That(someValue, Is.Not.Null, "Some message");
           // Assert.That(studentTree, Is.Not.Null,4, "Cauthan", "cauthan@example.com", "888-666-852", "Business", DateTime.Now)));

            Assert.IsNotNull(studentTree.Find(new Student(4, "Cauthan", "cauthan@example.com", "888-666-852", "Business", DateTime.Now)));
        ...
        public void BinaryTree_RemoveAndFind_ShouldReturnNull()
        {
            ...
            Student studentToRemove = new Student(4, "Cauthan", "don@example.com", "888-666-852", "Business", DateTime.Now);
        ...
        private List<Student> GetSampleStudents()
        {
            ...
            {
                new Student(4, "Cauthan", "cauthan@example.com", "888-666-852", "Business", DateTime.Now),
